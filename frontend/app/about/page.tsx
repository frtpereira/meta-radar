...
export const metadata: Metadata = {
    ...
    description:
        "Learn about Meta Radar, a fan-made analytics site for the Pokémon TCG competitive scene.",
};
        ...
        <main className="page">
            ...
            <div className="shell">
                <article>
                    ...
                    <p>
                        Every event, standing, and pairing shown on Meta Radar
                        comes from publicly available tournament data on{" "}
                        <a
                        ...
                        , sourced through their official API. We process that
                        data to:
                    </p>
                    ...
                    <ul>
                        ...
                        <li>
                            Track how those archetypes perform — win rates,
                            matchup spreads, and how the metagame shifts as new
                            sets and bans land.
                        </li>
                        <li>
                    ...
                    <p>
                        ...
                        not developed, operated, or endorsed by The Pokémon
                        Company, Nintendo, Creatures Inc., Game Freak, or
                    ...
                    <p>
                        Found a bug, spotted bad data, or have an idea for a
                        feature? Head to our{" "}
