        ...
        <main className="page">
            ...
            <div className="shell">
                <article>
                    ...
                    <p>
                        Meta Radar does not require an account, login, or
                        registration to use any feature of the Site. We do not
                        knowingly collect:
                    </p>
                    ...
                    <ul>
                        <li>
                            ...
                            (unless you email us directly — see Section 3).
                        </li>
                    ...
                    <p>
                        ...
                        analytics tools we use may automatically log standard
                    ...
                    <p>
                        This information is used only in aggregate, to
                        understand how the Site is used, to diagnose technical
                        problems, and to keep the Site secure. We do not use it
                        to identify individual visitors.
                    </p>

                    {/* 
                        If a specific analytics provider is added, such as
                        Plausible, Google Analytics, or a similar service,
                        name it here along with a link to its own privacy
                        policy and describe any cookies it sets.
                    */}
                    ...
                    <p>
                        If you contact us by email or open an issue on our
                        GitHub repository, we will see whatever information you
                        choose to include (such as your email address, GitHub
                        username, or the contents of your message). We use this
                        only to respond to you and to improve the Site, and we
                        do not sell or share it with third parties for marketing
                        purposes.
                    </p>
                    ...
                    <p>
                        The tournament, player, and match data shown on Meta
                        Radar is sourced from the publicly available Limitless
                        TCG API. Player names and results displayed on the Site
                        reflect information that tournament organizers and
                        Limitless TCG have already made public as part of
                        competitive event results. We do not independently
                        collect this information from players, and requests to
                        correct or remove it may need to be directed to the
                    ...
                    <p>
                        ...
                        to protect any information described above from
                    ...
                    <p>
                        ...
                        minimum age required in your jurisdiction), and we do
                        not knowingly collect personal information from
                        children. If you believe a child has provided us with
                        personal information, please contact us so we can remove
                        it.
                    </p>
                    ...
                    <ul>
                        ...
                        <li>
                            Use browser settings or extensions to block
                            analytics or tracking scripts, if any are added in
                            the future.
                        </li>
                        <li>
                            Contact us to ask what information, if any, we hold
                            that relates to you directly (e.g., from an email
                            you sent us).
                        </li>
                    </ul>
