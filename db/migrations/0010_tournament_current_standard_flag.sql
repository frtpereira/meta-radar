...
-- metas) so it can be filtered/indexed cheaply -- ingest keeps it in
-- sync going forward (see internal/ingest/sync.go), and a rotation
-- flips it for the outgoing era's tournaments (see
